...
<head>
  ...
  <link rel="icon" type="image/png" href="icon.png" />
	  ...
	  <link rel="stylesheet" href="{{ URL::asset('bootstrap2.css') }}"/>
         <!-- FONTAWESOME STYLES-->
         <link rel="stylesheet" href="{{ URL::asset('font-awesome.css') }}"/>
         <link rel="stylesheet" href="{{ URL::asset('font-awesome.min.css') }}"/>
            <!-- CUSTOM STYLES-->
        <link rel="stylesheet" href="{{ URL::asset('custom.css') }}"/>
        <link rel="stylesheet" href="{{ URL::asset('custom-made.css') }}"/>
        <!-- Custom Fonts -->
	...
	<nav class="navbar navbar-default">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a href="{{ url('/') }}">
					<img class="imgs" src="{{ URL::asset('icon.png') }}" height="40px" weight="50px" style="margin-top: 5px;">
				</a>
			</div>
		</div> 
	</nav>
